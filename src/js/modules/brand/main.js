...
$(document).ready(function () {
  ...
  function slickify() {
    peculiaritiesSlider.slick({
      ...
      slidesToScroll: 1,
      prevArrow:
        ".slider-pagination__peculiarities .slider-pagination__arrow_prev",
      nextArrow:
        ".slider-pagination__peculiarities .slider-pagination__arrow_next",
      mobileFirst: true,
      responsive: [
        {
          breakpoint: 991,
  ...
  const imgDesktop = brandPreloader.querySelector(".brand-preloader__desktop");
  const imgMobile = brandPreloader.querySelector(".brand-preloader__mobile");
